...
export default function GridSection({ onOpenAdmission }: GridSectionProps) {
  const { t } = useLanguage();
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-xs flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                <div className="flex items-center gap-2 text-slate-800">
                  ...
                  <h3 className="font-serif text-sm font-bold uppercase tracking-wide">{t("Announcements")}</h3>
                </div>
                <button
                ...
                {announcements.slice(0, 2).map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] font-bold text-slate-400">{t(item.date)}</span>
                    </div>
            ...
            <div className="pt-4 mt-4 border-t border-slate-50">
              <span className="text-[10px] text-slate-400 font-medium">{t("Daily bulletin updated weekly.")}</span>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-xs flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                <div className="flex items-center gap-2 text-slate-800">
                  ...
                  <h3 className="font-serif text-sm font-bold uppercase tracking-wide">{t("Upcoming Events")}</h3>
                </div>
                <button
              ...
              <div className="space-y-4">
                {events.slice(0, 2).map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      <span className="inline-block px-1.5 py-0.5 bg-emerald-50 text-emerald-800 rounded text-[9px] font-bold uppercase">
                        {t("Event")}
                      </span>
                      <span className="text-[9px] font-bold text-slate-400">{t(item.date)}</span>
                    </div>
            ...
            <div className="pt-4 mt-4 border-t border-slate-50">
              <span className="text-[10px] text-slate-400 font-medium">{t("Calendar subject to change.")}</span>
            </div>
          </div>
            ...
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                <div className="flex items-center gap-2 text-slate-800">
                  ...
                  <h3 className="font-serif text-sm font-bold uppercase tracking-wide">{t("Quick Links")}</h3>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between p-2.5 hover:bg-emerald-50/40 border border-slate-100 hover:border-emerald-100 rounded-lg text-left text-xs font-semibold text-slate-700 hover:text-emerald-800 transition-all cursor-pointer group"
                  >
                    <span>{t(link.name)}</span>
                    <ChevronRight className="h-3.5 w-3.5 text-slate-400 group-hover:translate-x-1 group-hover:text-emerald-800 transition-all" />
                  </button>
                ))}
              </div>
            </div>
            ...
            >
              ...
              <div className="border-b border-slate-100 pb-3 mb-4 space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-slate-400">{t(activeEvent.date)}</span>
                </div>
                <h4 className="font-serif text-lg font-bold text-slate-900 leading-tight">
                  {t(activeEvent.title)}
                </h4>
              ...
              <div className="space-y-3.5 text-xs text-slate-600 font-medium">
                <div className="grid grid-cols-2 gap-3 bg-slate-50 p-3 rounded-lg border border-slate-100">
                  <div>
                    <span className="block text-[9px] text-slate-400 font-bold uppercase">{t("Time Block")}</span>
                    <span className="text-slate-800 font-semibold">{t(activeEvent.time || "All Day")}</span>
                  </div>
                  <div>
                    <span className="block text-[9px] text-slate-400 font-bold uppercase">{t("Location")}</span>
                    <span className="text-slate-800 font-semibold">{t(activeEvent.location || "Campus Ground")}</span>
                  </div>
                </div>
            ...
            >
              ...
              <div className="border-b border-slate-100 pb-3 mb-4">
                <h3 className="font-serif text-lg font-bold text-slate-900 uppercase tracking-wide flex items-center gap-2">
                  ...
                  <span>{t("St. John's College Announcements")}</span>
                </h3>
              </div>
            ...
            >
              ...
              <div className="border-b border-slate-100 pb-3 mb-4">
                <h3 className="font-serif text-lg font-bold text-slate-900 uppercase tracking-wide flex items-center gap-2">
                  ...
                  <span>{t("St. John's College Event Calendar")}</span>
                </h3>
              </div>
              ...
              {selectedQuickLink === "fees" && (
                <div className="space-y-4">
                  <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
                    ...
                    <h4 className="font-serif text-lg font-bold text-slate-900">{t("Academic Fees Structure")}</h4>
                  </div>
                  <div className="text-xs text-slate-600 font-medium space-y-3">
                    <p>{t("St. John's College Mpigi maintains highly affordable fee standards with zero hidden charges. Below is the approved schedule for Term II, 2026:")}</p>
                    ...
                    <div className="p-3 bg-emerald-50 rounded-lg text-emerald-800 space-y-1.5">
                      <span className="font-bold text-[10px] uppercase block">{t("Includes:")}</span>
                      <p className="text-[11px] leading-relaxed">{t("Full boarding facilities, standard meals, educational software, library access, and basic dispensary health services.")}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {selectedQuickLink === "requirements" && (
                <div className="space-y-4">
                  <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
                    ...
                    <h4 className="font-serif text-lg font-bold text-slate-900">{t("Admission Requirements")}</h4>
                  </div>
                  <div className="text-xs text-slate-600 font-medium space-y-3">
                    <p>{t("To join St. John's College Mpigi, candidates must submit and satisfy the following educational requirements:")}</p>
                    <ul className="space-y-2 list-disc pl-4 text-slate-700">
                      <li><span className="font-bold text-slate-900">{t("PLE Result Slip:")}</span> {t("Photocopy of original PLE results from UNEB.")}</li>
                      <li><span className="font-bold text-slate-900">{t("Recommendation Letter:")}</span> {t("Clean conduct report from the previous primary/secondary school.")}</li>
                      <li><span className="font-bold text-slate-900">{t("Passport Photos:")}</span> {t("Three recent color passport photos of the candidate.")}</li>
                      <li><span className="font-bold text-slate-900">{t("Admission Assessment:")}</span> {t("Brief diagnostic interview in Mathematics and English.")}</li>
                    </ul>
                    <button
                      onClick={() => {
              ...
              {selectedQuickLink === "calendar" && (
                <div className="space-y-4">
                  <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
                    ...
                    <h4 className="font-serif text-lg font-bold text-slate-900">{t("Term II, 2026 School Calendar")}</h4>
                  </div>
                  <div className="text-xs text-slate-600 font-medium space-y-3.5">
                    <div className="space-y-2.5">
                      <div className="flex justify-between border-b border-slate-100 pb-1.5">
                        <span className="font-bold text-slate-800">{t("16th June, 2026")}</span>
                        <span className="text-emerald-800 font-semibold">{t("Reporting Day / Term II Starts")}</span>
                      </div>
                      <div className="flex justify-between border-b border-slate-100 pb-1.5">
                        <span className="font-bold text-slate-800 font-medium">{t("6th - 11th July")}</span>
                        <span className="text-slate-700">{t("O & A Level Mid-Term Assessments")}</span>
                      </div>
                      <div className="flex justify-between border-b border-slate-100 pb-1.5">
                        <span className="font-bold text-slate-800 font-medium">{t("2nd August, 2026")}</span>
                        <span className="text-slate-700 font-semibold">{t("Visitation Day & Class meetings")}</span>
                      </div>
                      <div className="flex justify-between border-b border-slate-100 pb-1.5">
                        <span className="font-bold text-slate-800 font-medium">{t("4th September, 2026")}</span>
                        <span className="text-rose-700 font-bold">{t("Term II Closes")}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
                    ...
                    <h4 className="font-serif text-lg font-bold text-slate-900">{t("UNEB National Exam Records")}</h4>
                  </div>
